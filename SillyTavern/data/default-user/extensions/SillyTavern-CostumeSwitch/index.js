...
// Kressa's Master Configuration for Weyland Switcher
const WEYLAND_SWITCHER_MASTER_CONFIG = {
    "enabled": true,
    "profiles": {
        "Default": {
            "patterns": [
                ...
                "Muse",
                "ghost",
                "{{getglobalvar::OCPick1}}"
            ],
            "ignorePatterns": [],
            "vetoPatterns": [],
            "allowedCharacters": "Weybot\nKinsbane Manor",
            "defaultCostume": "{{char}}/Regular Outfit",
            "debug": false,
            "globalCooldownMs": 1200,
            "perTriggerCooldownMs": 250,
            "failedTriggerCooldownMs": 10000,
            ...
            "repeatSuppressMs": 800,
            "mappings": [
                { "name": "Aiko", "folder": "Aiko/{{getvar::WeybotCostumeType}}" },
                { "name": "Ava", "folder": "Ava/{{getvar::WeybotCostumeType}}" },
                { "name": "Aethel", "folder": "Aethel/{{getvar::WeybotCostumeType}}" },
                { "name": "Bap", "folder": "Bap/{{getvar::WeybotCostumeType}}" },
                { "name": "Belle", "folder": "Belle/{{getvar::WeybotCostumeType}}" },
                { "name": "Bianca", "folder": "Bianca/{{getvar::WeybotCostumeType}}" },
                { "name": "Blake", "folder": "Blake/{{getvar::WeybotCostumeType}}" },
                { "name": "Cairo", "folder": "Cairo/{{getvar::WeybotCostumeType}}" },
                { "name": "Ellie", "folder": "Ellie/{{getvar::WeybotCostumeType}}" },
                { "name": "Fasti", "folder": "Fasti/{{getvar::WeybotCostumeType}}" },
                { "name": "Gem", "folder": "Gem/{{getvar::WeybotCostumeType}}" },
                { "name": "Hannah", "folder": "Hannah/{{getvar::WeybotCostumeType}}" },
                { "name": "Indigo", "folder": "Indigo/{{getvar::WeybotCostumeType}}" },
                { "name": "Jenn", "folder": "Jenn/{{getvar::WeybotCostumeType}}" },
                { "name": "Kai", "folder": "Kai/{{getvar::WeybotCostumeType}}" },
                { "name": "Karmen", "folder": "Karmen/{{getvar::WeybotCostumeType}}" },
                { "name": "Kiera", "folder": "Kiera/{{getvar::WeybotCostumeType}}" },
                { "name": "Kris", "folder": "Kris/{{getvar::WeybotCostumeType}}" },
                { "name": "Lentyl", "folder": "Lentyl/{{getvar::WeybotCostumeType}}" },
                { "name": "Lucy", "folder": "Lucy/{{getvar::WeybotCostumeType}}" },
                { "name": "Luna", "folder": "Luna/{{getvar::WeybotCostumeType}}" },
                { "name": "Lurkle", "folder": "Lurkle/{{getvar::WeybotCostumeType}}" },
                { "name": "Lyris", "folder": "Lyris/{{getvar::WeybotCostumeType}}" },
                { "name": "Mika", "folder": "Mika/{{getvar::WeybotCostumeType}}" },
                { "name": "Nix", "folder": "Nix/{{getvar::WeybotCostumeType}}" },
                { "name": "Rein", "folder": "Rein/{{getvar::WeybotCostumeType}}" },
                { "name": "Serra", "folder": "Serra/{{getvar::WeybotCostumeType}}" },
                { "name": "Seth", "folder": "Seth/{{getvar::WeybotCostumeType}}" },
                { "name": "Summer", "folder": "Summer/{{getvar::WeybotCostumeType}}" },
                { "name": "Vera", "folder": "Vera/{{getvar::WeybotCostumeType}}" },
                { "name": "Vesper", "folder": "Vesper/{{getvar::WeybotCostumeType}}" },
                { "name": "Warren", "folder": "Warren/{{getvar::WeybotCostumeType}}" },
                { "name": "Vindica", "folder": "Vindica/{{getvar::WeybotCostumeType}}" },
                { "name": "Rivera", "folder": "Rivera/{{getvar::WeybotCostumeType}}" },
                { "name": "Nara", "folder": "Nara/{{getvar::WeybotCostumeType}}" },
                { "name": "Kressa", "folder": "Kressa/{{getvar::WeybotCostumeType}}" },
                { "name": "Bastet", "folder": "Bastet/{{getvar::WeybotCostumeType}}" },
                { "name": "Rivet", "folder": "Rivet/{{getvar::WeybotCostumeType}}" },
                { "name": "Gemini", "folder": "Gemini/{{getvar::WeybotCostumeType}}" },
                { "name": "Jericho", "folder": "Jericho/{{getvar::WeybotCostumeType}}" },
                { "name": "Holo", "folder": "Holo/{{getvar::WeybotCostumeType}}" },
                { "name": "Loona", "folder": "Loona/{{getvar::WeybotCostumeType}}" },
                { "name": "Willow", "folder": "Willow/{{getvar::WeybotCostumeType}}" },
                { "name": "Rosa", "folder": "Rosa/{{getvar::WeybotCostumeType}}" },
                { "name": "Eve", "folder": "Eve/{{getvar::WeybotCostumeType}}" },
                { "name": "Rosanna", "folder": "Rosanna/{{getvar::WeybotCostumeType}}" },
                { "name": "Briar", "folder": "Briar/{{getvar::WeybotCostumeType}}" },
                { "name": "Muse", "folder": "Muse/{{getvar::WeybotCostumeType}}" },
                { "name": "ghost", "folder": "Kinsbane Manor/Ghost" },
                { "name": "{{getglobalvar::OCPick1}}", "folder": "Weybot/{{getglobalvar::OCPick1}}/{{getvar::WeybotCostumeType}}" },
                { "name": "{{getglobalvar::OCPick2}}", "folder": "Weybot/{{getglobalvar::OCPick2}}/{{getvar::WeybotCostumeType}}" },
                { "name": "{{getglobalvar::OCPick3}}", "folder": "Weybot/{{getglobalvar::OCPick3}}/{{getvar::WeybotCostumeType}}" }
            ],
            "detectAttribution": true,
            "detectAction": true,
            "detectVocative": true,
...
function computeFlagsFromEntries(entries, requireI = true) { const f = new Set(); for (const e of entries) { if (!e) continue; for (const c of (e.flags || '')) f.add(c); } return Array.from(f).filter(c => 'gimsuy'.includes(c)).join(''); }
...
function buildSpeakerRegex(patternList) { const e = (patternList || []).map(parsePatternEntry).filter(Boolean); if (!e.length) return null; const p = e.map(x => `(?:${x.body})`), b = `(?:^|\\n)\\s*(?:__|\\*\\*)?\\s*(${p.join('|')})\\s*(?:__|\\*\\*)?\\s*[:;,]\\s*(?:__|\\*\\*)?`; f = computeFlagsFromEntries(e, !0); try { return new RegExp(b, f) } catch (err) { return console.warn("buildSpeakerRegex compile failed:", err), null } }
...
function debugLog(settings,...args){try{settings&&getActiveProfile(settings)?.debug&&console.debug.apply(console,["[WeylandSwitch]"].concat(args))}catch(e){}}
...
jQuery(async () => {
    if (typeof executeSlashCommandsOnChatInput !== 'function') {
        console.error("[WeylandSwitch] FATAL: The global 'executeSlashCommandsOnChatInput' function is not available.");
    ...
    if (!ok) console.warn("WeylandSwitch: settings UI did not appear within timeout.");
    ...
    function loadProfile(profileName) {
        ...
        $("#cs-allowed-characters").val(profile.allowedCharacters || "");
    ...
    function tryWireUI() {
        ...
        $("#cs-save").off('click.cs').on("click.cs", () => {
            ...
            profile.allowedCharacters = $("#cs-allowed-characters").val().trim();
        ...
        $("#cs-profile-save").off('click.cs').on("click.cs", () => {
            ...
            const profileData = {
                ...
                allowedCharacters: $("#cs-allowed-characters").val().trim(),
        ...
        $("#cs-profile-delete").off('click.cs').on("click.cs", () => {
            ...
            if (!settings.profiles[profileNameToDelete]) {
                console.error(`[WeylandSwitch] Tried to delete a non-existent profile: "${profileNameToDelete}"`);
    ...
    async function manualReset() {
        ...
        try {
            ...
            setTimeout(() => $("#cs-status").text("Ready"), 1500);
        } catch (err) { console.error(`[WeylandSwitch] Manual reset failed for "${costumeArg}".`, err); }
    }
    ...
    async function issueCostumeForName(name, opts = {}) {
        ...
        console.log(`[Weyland Switcher] Attempting to switch costume. Detected Name: '${name}', Mapped Folder: '${argFolder}', Full Command: '${command}'`);
        ...
        try {
            ...
            console.error(`[WeylandSwitch] Failed to execute /costume command for "${argFolder}".`, err);
        }
    }
    ...
    _streamHandler = (...args) => {
        try {
            ...
            if (allowedCharsRaw.trim().length > 0) {
                ...
                const isAllowed = allowedList.includes(currentCharacterName);

                // TEMPORARY DEBUG LOGGING
                console.log("[Weyland Switcher Debug] Whitelist Check in _streamHandler...");
                console.log(" > Current Character:", `'${currentCharacterName}'`);
                console.log(" > Is Allowed?", isAllowed);

                if (!isAllowed) {
                    console.log("[Weyland Switcher Debug] ABORTING: Character not in allowed list.");
                    return; // <<< FORCE STOP
                }
            }
        ...
        } catch (err) { console.error("WeylandSwitch stream handler error:", err); }
    };
    ...
    try { unload(); } catch (e) {}
    try { eventSource.on(streamEventName, _streamHandler); eventSource.on(event_types.GENERATION_STARTED, _genStartHandler); eventSource.on(event_types.GENERATION_ENDED, _genEndHandler); eventSource.on(event_types.MESSAGE_RECEIVED, _msgRecvHandler); eventSource.on(event_types.CHAT_CHANGED, _chatChangedHandler); } catch (e) { console.error("WeylandSwitch: failed to attach event handlers:", e); }
    try { window[`__${extensionName}_unload`] = unload; } catch (e) {}
    console.log("Weyland-Switch v1.0 loaded successfully.");
});

function getSettingsObj() {
    console.log("[Weyland Switcher] Forcing master configuration. User settings are ignored.");
    const ctx = typeof getContext === 'function' ? getContext() : (typeof SillyTavern !== 'undefined' ? SillyTavern.getContext() : null);

    // This is the key change: We create a temporary storage object
    // and forcefully place our master config into it.
    const temporaryStore = {
        [extensionName]: JSON.parse(JSON.stringify(WEYLAND_SWITCHER_MASTER_CONFIG))
    };

    // We then return this temporary object as if it were the real settings.
    // The save function is replaced with a dummy that does nothing.
    return {
        store: temporaryStore,
        save: () => console.log("[Weyland Switcher] Saving is disabled."),
        ctx
    };
}
