...
const WEYLAND_SWITCHER_MASTER_CONFIG = {
    ...
    "profiles": {
        "Default": {
            ...
            "repeatSuppressMs": 800,
            "mappings": [
                { "name": "Aiko", "folder": "Aiko/Regular Outfit" },
                { "name": "Ava", "folder": "Ava/Regular Outfit" },
                { "name": "Aethel", "folder": "Aethel/Regular Outfit" },
                { "name": "Bap", "folder": "Bap/Regular Outfit" },
                { "name": "Belle", "folder": "Belle/Regular Outfit" },
                { "name": "Bianca", "folder": "Bianca/Regular Outfit" },
                { "name": "Blake", "folder": "Blake/Regular Outfit" },
                { "name": "Cairo", "folder": "Cairo/Regular Outfit" },
                { "name": "Ellie", "folder": "Ellie/Regular Outfit" },
                { "name": "Fasti", "folder": "Fasti/Regular Outfit" },
                { "name": "Gem", "folder": "Gem/Regular Outfit" },
                { "name": "Hannah", "folder": "Hannah/Regular Outfit" },
                { "name": "Indigo", "folder": "Indigo/Regular Outfit" },
                { "name": "Jenn", "folder": "Jenn/Regular Outfit" },
                { "name": "Kai", "folder": "Kai/Regular Outfit" },
                { "name": "Karmen", "folder": "Karmen/Regular Outfit" },
                { "name": "Kiera", "folder": "Kiera/Regular Outfit" },
                { "name": "Kris", "folder": "Kris/Regular Outfit" },
                { "name": "Lentyl", "folder": "Lentyl/Regular Outfit" },
                { "name": "Lucy", "folder": "Lucy/Regular Outfit" },
                { "name": "Luna", "folder": "Luna/Regular Outfit" },
                { "name": "Lurkle", "folder": "Lurkle/Regular Outfit" },
                { "name": "Lyris", "folder": "Lyris/Regular Outfit" },
                { "name": "Mika", "folder": "Mika/Regular Outfit" },
                { "name": "Nix", "folder": "Nix/Regular Outfit" },
                { "name": "Rein", "folder": "Rein/Regular Outfit" },
                { "name": "Serra", "folder": "Serra/Regular Outfit" },
                { "name": "Seth", "folder": "Seth/Regular Outfit" },
                { "name": "Summer", "folder": "Summer/Regular Outfit" },
                { "name": "Vera", "folder": "Vera/Regular Outfit" },
                { "name": "Vesper", "folder": "Vesper/Regular Outfit" },
                { "name": "Warren", "folder": "Warren/Regular Outfit" },
                { "name": "Vindica", "folder": "Vindica/Regular Outfit" },
                { "name": "Rivera", "folder": "Rivera/Regular Outfit" },
                { "name": "Nara", "folder": "Nara/Regular Outfit" },
                { "name": "Kressa", "folder": "Kressa/Regular Outfit" },
                { "name": "Bastet", "folder": "Bastet/Regular Outfit" },
                { "name": "Rivet", "folder": "Rivet/Regular Outfit" },
                { "name": "Gemini", "folder": "Gemini/Regular Outfit" },
                { "name": "Jericho", "folder": "Jericho/Regular Outfit" },
                { "name": "Holo", "folder": "Holo/Regular Outfit" },
                { "name": "Loona", "folder": "Loona/Regular Outfit" },
                { "name": "Willow", "folder": "Willow/Regular Outfit" },
                { "name": "Rosa", "folder": "Rosa/Regular Outfit" },
                { "name": "Eve", "folder": "Eve/Regular Outfit" },
                { "name": "Rosanna", "folder": "Rosanna/Regular Outfit" },
                { "name": "Briar", "folder": "Briar/Regular Outfit" },
                { "name": "Muse", "folder": "Muse/Regular Outfit" },
                { "name": "ghost", "folder": "Kinsbane Manor/Ghost" },
                { "name": "{{getglobalvar::OCPick1}}", "folder": "Weybot/{{getglobalvar::OCPick1}}" }
            ],
            "detectAttribution": true,
            "detectAction": true,
            "detectVocative": true,
